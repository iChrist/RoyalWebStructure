...
<table cellspacing="0" style="width: 100%; border: solid 1px black; background: #FFF; text-align: center; font-size: 10pt;">
    ...
    <tr>
        ...
        <td colspan="2" style="border: solid 1px #000000; background: #E7E7E7;"><strong>Nº Factura</strong></td>
        <td colspan="2" style="border: solid 1px #000000;"><?php echo (isset($result['numeroFactura'])) ? utf8_encode($result['numeroFactura']) : ''; ?></td>
    </tr>
    <tr>
        ...
        <td colspan="2" style="border: solid 1px #000000;"><?php echo (isset($result['paisOrigen'])) ? utf8_encode($result['paisOrigen']) : ''; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="2" style="border-left: solid 1px #000000; border-right: solid 1px #000000;">EXAHUSTIVO [&nbsp;&nbsp;]</td>
    </tr>
    <tr>
        ...
        <td colspan="2" style="border-left: solid 1px #000000; border-right: solid 1px #000000;">OCULAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;]</td>
        <td colspan="2" style="border-left: solid 1px #000000; border-right: solid 1px #000000;">ETIQUETADO [&nbsp;&nbsp;]</td>
    </tr>
    <tr>
        <td colspan="2" style="border-left: solid 1px #000000; border-right: solid 1px #000000; ">OTROS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;]</td>
        <td colspan="2" style="border-left: solid 1px #000000; border-right: solid 1px #000000; ">OTROS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;]</td>
        <td colspan="2" style="border: solid 1px #000000; ">DES Y CONS&nbsp;&nbsp;[&nbsp;&nbsp;]</td>
        <td colspan="2" style="border: solid 1px #000000;">OTROS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;]</td>
    </tr>
    <tr>
