      ...
      <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
        <thead>
          ...
          <tr role="row" class="filter">
            <td><input type="text" class="form-control form-filter input-sm" name="sName" placeholder="Nombre"></td>
            <td><input type="text" class="form-control form-filter input-sm" name="skModules" placeholder="Modulo"></td>
            <td><input type="text" class="form-control form-filter input-sm" name="sIp" placeholder="IP"></td>
            <td></td>
