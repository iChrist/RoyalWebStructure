...
<form id="_save" method="post" class="form-horizontal" role="form" enctype="multipart/form-data"> 
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-2">Correo electr&oacute;nico <span aria-required="true" class="required"> * </span>
            </label>
            <div class="col-md-4">
                <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" name="sCorreo" id="sCorreo" class="form-control" placeholder="Correo electr&oacute;nico" value="<?php echo (isset($result['sCorreo'])) ? utf8_encode($result['sCorreo']) : '' ; ?>" >
                </div>
            </div>
        </div>
