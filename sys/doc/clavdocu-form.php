...
<form id="_save" method="post" class="form-horizontal" role="form" enctype="multipart/form-data"> 
    <input type="hidden" name="skClaveDocumentoViejo"  id="skClaveDocumentoViejo" value="<?php echo (isset($result['skClaveDocumento'])) ? $result['skClaveDocumento'] : '' ; ?>">
    <div class="form-body">
         <div class="form-group">
            <label class="control-label col-md-2">Clave de Documento <span aria-required="true" class="required"> * </span>
            </label>
            <div class="col-md-4">
                <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" maxlength="4" name="skClaveDocumento" id="skClaveDocumento" class="form-control" placeholder="Clave del Documento" value="<?php echo (isset($result['skClaveDocumento'])) ? utf8_encode($result['skClaveDocumento']) : '' ; ?>" >
                </div>
            </div>
        </div>
        <div class="form-group">
