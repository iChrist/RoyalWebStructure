...
<link href="<?php echo SYS_URL; ?>core/assets/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
<!-- NOTIFICATIONS !-->
...
<link href="<?php echo SYS_URL; ?>core/assets/css/pages/portfolio.css" rel="stylesheet" type="text/css"/>
...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
            <a href="<?php echo SYS_URL; ?>" style="text-decoration:none;font-weight:bold;color:#fff;">
                <!--<img src="<?php echo SYS_URL; ?>core/assets/img/logo.svg" alt="logo" style="width:110px;height:40px;margin:5px;"/>!-->
                <h4>GOMEZ Y ALVEZ</h4>
            </a>
        </div>
